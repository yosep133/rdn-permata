...
class NotifJob implements ShouldQueue
{
    ...
    public function handle(): void
    {
        try {
            ...
            Log::channel('notif')->info($permata);
    ...
    public function insertCashBo($account,$permata):bool 
    {
        ...
        $msgRqHdr = $permata->MsgRqHdr;
        $transactionInfo = $permata->TransactionInfo;
        $statements = $transactionInfo->Statements;
        ...
        Log::channel('notif')->info('insert amount'.$amount.' ' );
        //  sending to cash bo 
        ...
        if ($result) {
            ...
            Log::channel('notif')->info('send to Cashbo '.
